...
--
-- Continúa de 0130. Inserta/actualiza todos los precios del Excel
-- PRECIOS CLIENTES 2026.
--
-- Idempotente: usa ON CONFLICT (code) DO UPDATE → re-ejecutable.

-- ── 4.1 Terapias individuales ─────────────────────────────────────────────
...
-- ── 4.2 Pruebas psicológicas adicionales ───────────────────────────────
INSERT INTO public.service_catalog
...
-- ── 4.3 Matrículas / mensualidades / materiales / uniformes / evaluaciones
-- (Idempotente: si los items ya existen del 0107 se actualizan, si no se crean.)

-- Matrículas BK/LK + Aula (prorrateadas)
INSERT INTO public.service_catalog
...
-- Entrevistas / Asesorías / Evaluaciones clínicas + DX TEA
