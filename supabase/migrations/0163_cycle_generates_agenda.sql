...
--
-- Esta migración es RÁPIDA (solo redefine funciones). El BACKFILL de los ciclos
-- pendientes que ya quedaron sin citas se hace APARTE, en tandas, para no exceder
-- el timeout del editor SQL de Supabase ("Failed to fetch"):
--   → supabase/scripts/backfill_0163_cycle_appointments.sql
--
...
-- ── 4. Backfill → script aparte (ver cabecera) ───────────────────────────────
-- supabase/scripts/backfill_0163_cycle_appointments.sql (en tandas).
