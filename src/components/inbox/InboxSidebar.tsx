    ...
    <aside className="flex flex-col h-full w-full sm:w-72 bg-fm-surface-container-lowest border-r border-fm-surface-container-high flex-shrink-0">
      ...
      <div className="p-4">
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 bg-fm-primary text-white btn-action py-2.5 px-4 rounded-lg font-semibold text-sm hover:opacity-90 transition-opacity"
        >
