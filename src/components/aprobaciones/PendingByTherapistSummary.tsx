          ...
          <div className="mt-3 space-y-3">
            {groups.map((g) => (
              <details key={g.therapistId} className="group">
                <summary className="cursor-pointer list-none flex items-center justify-between gap-2 hover:bg-amber-100/60 rounded px-2 py-1 -mx-2">
                  ...
                  <span className="material-symbols-outlined text-amber-700 text-base transition-transform group-open:rotate-180">
                    expand_more
                  </span>
                </summary>
