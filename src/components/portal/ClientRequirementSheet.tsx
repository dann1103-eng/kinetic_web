      ...
      >
        ...
        <div className="flex items-start justify-between px-5 pt-5 pb-3 border-b border-fm-surface-container-high pr-14 flex-shrink-0">
          ...
          <div className="flex-shrink-0 ml-3">
            {approved ? (
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#00675c]/10 text-[#00675c] text-xs font-semibold">
              ...
              <button
                ...
                disabled={approving}
                className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[#00675c] text-white text-xs font-bold hover:bg-[#005549] disabled:opacity-60 transition-colors"
              >
            ...
            {approveError && (
              <p className="text-[10px] text-[#b31b25] mt-1 text-right">{approveError}</p>
            )}
          </div>
        </div>
